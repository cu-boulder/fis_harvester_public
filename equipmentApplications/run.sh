...
harvester-transfer -i ../vivo.model.xml -ImodelName=http://vitro.mannlib.cornell.edu/a/graph/ws_eq_construct -d data/constructed-data
...
#Output some counts
APP=`cat data/constructed-data | grep 'Equipment' | wc -l`
echo "Imported $APP applications of equipment"
