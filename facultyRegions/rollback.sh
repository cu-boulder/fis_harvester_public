...
export HARVEST_NAME=dat-rollback-faculty-regions
...
harvester-transfer -o ../vivo.model.xml -OmodelName=http://vitro.mannlib.cornell.edu/a/graph/ws_fm2r_construct -r ../backups/facultyRegions-data-last
