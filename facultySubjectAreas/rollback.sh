...
export HARVEST_NAME=dat-faculty-subjectarea-rollback
...
harvester-transfer -o vivo.model.xml -OmodelName=http://vitro.mannlib.cornell.edu/a/graph/ws_fm2sa_construct -r ../backups/facultySubjectAreas-data-last
