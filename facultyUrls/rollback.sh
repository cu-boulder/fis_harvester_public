...
export HARVEST_NAME=dat-rollback-faculty-degrees
...
harvester-transfer -o ../vivo.model.xml -OmodelName=http://vitro.mannlib.cornell.edu/a/graph/ws_fm2url_construct -r ../backups/facultyDegrees-data-last
