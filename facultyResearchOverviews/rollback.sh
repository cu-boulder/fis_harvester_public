...
export HARVEST_NAME=dat-rollback-faculty-research-overviews
...
harvester-transfer -o ../vivo.model.xml -OmodelName=http://vitro.mannlib.cornell.edu/a/graph/ws_fm2ro_construct -r ../backups/facultyResearchOverviews-data-last
