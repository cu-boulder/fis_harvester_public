...
export HARVEST_NAME=dat-rollback-faculty-countries
...
harvester-transfer -o ../vivo.model.xml -OmodelName=http://vitro.mannlib.cornell.edu/a/graph/ws_fm2c_construct -r ../backups/facultyCountries-data-last
