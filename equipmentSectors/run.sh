...
export HARVEST_NAME=dat-equipmentsectors
...
harvester-sparqltranslator -X equipment.config.xml

# Backup constructed data
harvester-transfer -i ../vivo.model.xml -ImodelName=http://vitro.mannlib.cornell.edu/a/graph/ws_eqsectors_construct -d data/constructed-data
...
#Output some counts
SEC=`cat data/constructed-data | grep 'Equipment' | wc -l`
echo "Imported $SEC sectors of equipment"
