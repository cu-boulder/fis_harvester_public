...
export HARVEST_NAME=dat-rollback-faculty-positions
...
harvester-transfer -o vivo.model.xml -OmodelName=http://vitro.mannlib.cornell.edu/a/graph/ws_fm2p_construct -r ../backups/facultyPositions-data-last
