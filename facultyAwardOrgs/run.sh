...
harvester-sparqltranslator -X awardorg.config.xml

# Backup constructed data
harvester-transfer -i ../vivo.model.xml -ImodelName=http://vitro.mannlib.cornell.edu/a/graph/ws_awor_construct -d data/constructed-data
